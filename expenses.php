...
<html en-US>
    ...
    <body class="body">
        ...
        <div class="body-content">
            ...
            <button <?php if ($admin === 0) { echo 'hidden'; } ?> onclick="exportTableToExcel('expenses-table', 'expenses')" style="border:2px solid grey; width:130px; height:30px;">Export to Excel</button>
            ...
            <table id="expenses-table">
                ...
                <tbody>
                    <?php
                        ...
                        $sqlExpenses = "SELECT * FROM expenses ORDER BY date DESC";
